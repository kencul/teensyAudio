...
AudioInputUSB usb;
AudioMixer4 inMixer;
AudioConnection c1(usb, 0, inMixer, 0);
AudioConnection c2(usb, 1, inMixer, 1);

//AudioSynthWaveform saw;


AudioSynthWaveform   sine[4];
...
AudioMixer4              synthMixer;         //xy=303,1187

AudioConnection          c11(sine[0], 0, env[0], 0);
AudioConnection          c12(env[0], 0, synthMixer, 2);
AudioConnection          c13(sine[1], 0, env[1], 0);
AudioConnection          c14(env[1], 0, synthMixer, 3);
AudioConnection          c15(sine[2], 0, env[2], 0);
AudioConnection          c16(env[2], 0, synthMixer, 0);
AudioConnection          c7(sine[3], 0, env[3], 0);
AudioConnection          c8(env[3], 0, synthMixer, 1);
...
AudioMixer4              vocoderMixer;        //xy=1791,1665
...
AudioConnection pc1(synthMixer, 0, outputMixer, 0);
AudioConnection pc2(inMixer, 0, outputMixer, 1);
AudioConnection pc3(vocoderMixer, 0, outputMixer, 2);
AudioConnection pc4(outputMixer, 0, i2s1, 0);
AudioConnection pc5(outputMixer, 0, i2s1, 1);

//AudioOutputUSB           usb1;           //xy=2187.555633544922,661.6666431427002
AudioConnection          patchCord1(inMixer, 0, mixer1, 0);
//AudioConnection          patchCord2(usb, 0, mixer2, 0);
...
AudioConnection          patchCord25(synthMixer, 0, filter39, 0);
AudioConnection          patchCord26(synthMixer, 0, filter41, 0);
AudioConnection          patchCord27(synthMixer, 0, filter43, 0);
AudioConnection          patchCord28(synthMixer, 0, filter45, 0);
AudioConnection          patchCord29(synthMixer, 0, filter47, 0);
AudioConnection          patchCord30(synthMixer, 0, filter49, 0);
AudioConnection          patchCord31(synthMixer, 0, filter51, 0);
AudioConnection          patchCord32(synthMixer, 0, filter53, 0);
AudioConnection          patchCord33(synthMixer, 0, filter55, 0);
AudioConnection          patchCord34(synthMixer, 0, filter57, 0);
AudioConnection          patchCord35(synthMixer, 0, filter59, 0);
AudioConnection          patchCord36(synthMixer, 0, filter61, 0);
AudioConnection          patchCord37(synthMixer, 0, filter63, 0);
AudioConnection          patchCord38(synthMixer, 0, filter65, 0);
AudioConnection          patchCord39(synthMixer, 0, filter67, 0);
AudioConnection          patchCord40(synthMixer, 0, filter69, 0);
AudioConnection          patchCord41(synthMixer, 0, filter71, 0);
AudioConnection          patchCord42(synthMixer, 0, filter73, 0);
AudioConnection          patchCord43(synthMixer, 0, filter75, 0);
//AudioConnection          patchCord44(mixer2, 0, mixer11, 2);
AudioConnection          patchCord45(synthMixer, peak21);
...
AudioConnection          patchCord105(noise1, 0, synthMixer, 1);
...
AudioConnection          patchCord156(mixer9, 0, vocoderMixer, 0);
AudioConnection          patchCord157(mixer10, 0, vocoderMixer, 1);
...
//AudioConnection          patchCord169(synthMixer, 0, i2s1, 1);
//AudioConnection          patchCord1699(synthMixer, 0, i2s1, 0);
...
// prepare built in LED
  ...
  synthMixer.gain(0, 0.25);  // Balance mixer levels (4 voices = 0.25 each)
  synthMixer.gain(1, 0.25);
  synthMixer.gain(2, 0.25);
  synthMixer.gain(3, 0.25);
  ...
  outputMixer.gain(1, 0);
  outputMixer.gain(2, 0);

  for(u_int i = 0; i < 4; i++){
          sine[i].begin(WAVEFORM_SAWTOOTH);
  }
  ...
  noise1.amplitude(0);            // controls sibilance (hiss syllables)
  mixer1.gain(0, 1);                // I2S left input level
  vocoderMixer.gain(0, 0.7);             // vocoder output 1 level (low-mid freq)
  vocoderMixer.gain(1, 0.7);             // vocoder output 2 level (high freq)
  vocoderMixer.gain(2, 0);               // instrument to output mix level
  ...
  if (button0.fallingEdge()){
    ...
    switch(outputMode){
      case 0:
        ...
        outputMixer.gain(1, 0);
        outputMixer.gain(2, 0);
        Serial.println("Output mode: synth");
        break;
     case 1:
        outputMixer.gain(0, 0);
        outputMixer.gain(1, 1);
        outputMixer.gain(2, 0);
        Serial.println("Output mode: USB audio");
          break;
      case 2:
        outputMixer.gain(0, 0);
        outputMixer.gain(1, 0);
        outputMixer.gain(2, 1);
        Serial.println("Output mode: vocoder");
        break;
      case 3:
        outputMixer.gain(0, 0);
        outputMixer.gain(1, 0.5);
        outputMixer.gain(2, 0.5);
        Serial.println("Output mode: vocoder + USB audio");
        break;
      default:
        break;
    }
    ...
    if (button1.fallingEdge()){
      ...
      case 0:
        ...
        Serial.println("Synth waveform: saw");
        break;
     case 1:
        for(u_int i = 0; i < 4; i++){
          sine[i].begin(WAVEFORM_SQUARE);
        }
        Serial.println("Synth waveform: square");
          break;
      case 2:
        for(u_int i = 0; i < 4; i++){
          sine[i].begin(WAVEFORM_SINE);
        }
        Serial.println("Synth waveform: sine");
        break;
      default:
        break;
    }
